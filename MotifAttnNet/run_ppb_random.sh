...
for DATASET_NAME in {"ppb_random_split",}
...
do
  ...
  do
    ...
    python ./main.py         --seed ${SEED} \
                              ...
                              --result_path ${PROJECT_DIRECTORY}/result/PPB/PPB_motif_setrep/${DATASET_NAME}_run${SEED} \
                              --save_interpret True \
...
# nohup bash run_ppb_random.sh >ppb_random_motif_nosetrep.log 2>&1 &